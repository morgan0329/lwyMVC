...
public class LwyApplicationContext {
    ...
    public LwyApplicationContext(String location) {
    ...
    private void doCreateBean() {
        ...
        try {
            ...
            for (String className : classCache) {
                ...
                } else if (clazz.isAnnotationPresent(LwyService.class)) {
                    LwyService service = clazz.getAnnotation(LwyService.class);
    ...
    private void populate() {
        ...
        for (Map.Entry<String, Object> entry : instanceMapping.entrySet()) {
            ...
            for (Field field : fields) {
                ...
                if (!field.isAnnotationPresent(LwyAutowired.class)) {
                    continue;
                }

                LwyAutowired autowired = field.getAnnotation(LwyAutowired.class);
